#!/usr/bin/env python3
"""
Nigerian Road Risk Reporter - Ultra Lite Version
Minimal, Clean, No File Uploads, Error Suppressed
"""
...
# Main application
def main():
    st.markdown('<div class="main-header"><h1>🛣️ Nigerian Road Risk Reporter</h1><p>Lightweight Road Status System</p></div>', unsafe_allow_html=True)
...
def show_about_page():
    ...
    A lightweight, clean version of the Nigerian Road Risk Reporting application.
    ...
    - ✅ No file uploads (for simplicity)
